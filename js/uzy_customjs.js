...
setInterval(() => {
  ...
  //      console.log('FitCas TV butonu eklendi:', fitcasTVButton);
    //  }
      ...
      if (!sidebarLinks.querySelector('a[href="/tr/wheel"]')) {
        const fitcasCarkButton = document.createElement('a');
        fitcasCarkButton.href = '/tr/wheel';
...
//        if (signInBtn) headerActions.insertBefore(fitTvLink, signInBtn);
 ...
 //     }
      ...
      // 2) Fit ÇARK linki
       if (!headerActions.querySelector('.header__fitCark') && !headerActions.querySelector('.header__wallet')) {
        const fitCarkLink = document.createElement('a');
        fitCarkLink.className = 'header__fitCark uzy_button uzy_button2 uzy_light_3';
        fitCarkLink.href = '/tr/wheel';
        fitCarkLink.innerHTML = `
          <span>Fit ÇARK</span>`;
        if (signInBtn) headerActions.insertBefore(fitCarkLink, signInBtn);
        else headerActions.prepend(fitCarkLink);
        console.log('Fit ÇARK linki eklendi:', fitCarkLink);
      }
      if (headerActions.querySelector('.header__fitCark') && headerActions.querySelector('.header__wallet')) {
        headerActions.querySelector('.header__fitCark').remove();
      }
    }
    ...
    function createCustomSections() {
        ...
        const CasinoP = document.querySelector('#top-games-wrapper > .container')?.parentNode;
        if (!CasinoP ) return;

        const headerParent = document.querySelector('#main-slider')?.parentNode;
        if (!headerParent) return;

        const parent = document.querySelector('#top-games-wrapper')?.parentNode;
        if (!parent) return;

        // 0) Eğer daha önce eklenmemişse uzy_header_section
        if (!document.querySelector('.uzy_header_section')) {
            const sec1 = document.createElement('div');
            sec1.className = 'container uzy_header_section section';
             if(window.innerWidth > 768)
            {
              sec1.innerHTML = `<img src="https://github.com/Neo777Uzy/fitcas/blob/main/Homepage_Head_Desktop.png?raw=true" alt=""><a class="uzy_button3" href="https://t.me/FitcasOfficial" target="_blank" style="position:absolute;margin-top:-55px;margin-left: 45px;"><span>Telegram Kanalımız</span></a>`;
            }
             if(window.innerWidth <= 768)
            {
              sec1.innerHTML = `<img src="https://github.com/Neo777Uzy/fitcas/blob/main/Homepage_Head_Mobile.png?raw=true" alt=""><a class="uzy_button3" href="https://t.me/FitcasOfficial" target="_blank" style="position:absolute;margin-top: -40px;margin-left: 20px;padding: 5px 10px;scale:0.7;"><span>Telegram Kanalımız</span></a>`;
            }
            headerParent.insertBefore(sec1, document.getElementById('main-slider'));
        }
       ...
       // // 1) Eğer daha önce eklenmemişse custom-section1
        ...
        //   sec3.innerHTML = `<a href="/tr/sportsbook"><img src="https://cdn.jsdelivr.net/gh/Neo777Uzy/fitcas@master/bjk-fb-min.jpg?raw=true" alt=""></a>`;
       //     parent.insertBefore(sec3, document.getElementById('top-games-wrapper'));
        //}
       ...
       // }
        ...
        // Casino Ayırac
        if (!document.querySelector('.uzy_casino_section')) {
            const sec1 = document.createElement('div');
            sec1.className = 'container uzy_casino_section section';
             if(window.innerWidth > 768)
            {
              sec1.innerHTML = `<img src="https://raw.githubusercontent.com/Neo777Uzy/fitcas/refs/heads/main/Slot%20Casino%20Ayrac%20Web.png?raw=true" alt="">`;
            }
             if(window.innerWidth <= 768)
            {
              sec1.innerHTML = `<img src="https://raw.githubusercontent.com/Neo777Uzy/fitcas/refs/heads/main/Slot%20Casino%20Ayrac%20Mobile.png?raw=true" alt="">`;
            }
            CasinoP.insertBefore(sec1, document.querySelector('#top-games-wrapper > .container'));
        }
    ...
    function removeCustomSections() {
        const sections = document.querySelectorAll('.custom-section1, .uzy_header_section2, .uzy_header_section');
